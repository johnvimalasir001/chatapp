...
import 'package:chatrat/Preview/image_preview_screen.dart';
import 'package:chatrat/fake_data/datas/data.dart';
import 'package:chatrat/models/previous_message_structure.dart';
...
class _ChatScreenState extends State<ChatScreen> {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (itemBuilderContext, index) {
                    if (this._chatMessageCategoryHolder[index] ==
                      ...
                      return _sendermsgBox(itemBuilderContext, index);
  ...
  Widget _timeReFormat(String _willReturnTime, int index) {
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Center(
                child: IconButton(
                  splashRadius: 1,
                  onPressed: () => _writeTextPresent ? _sendText : _voiceTake,
                  icon: const Icon(
                    Icons.send_rounded,
                  ),
                ),
  ...
  Widget _sendermsgBox(BuildContext itemBuilderContext, int index) {
    return Padding(
          ...
          children: [
            Container(
              margin: _conversationMessageHolder[index]
                  ? EdgeInsets.only(
                      right: _allConversationMessages[index].keys.first.length <
                              100
                  ...
                  : EdgeInsets.only(
                      left: _allConversationMessages[index].keys.first.length <
                              100
                          ? MediaQuery.of(context).size.width / 2
                          : MediaQuery.of(context).size.width / 5,
                    ),
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.only(
                  ...
                  bottomLeft: _conversationMessageHolder[index]
                      ? const Radius.circular(0)
                      : const Radius.circular(20),
                ),
              ),
  ...
  //             backgroundColor: this._conversationMessageHolder[index]
  ...
  Widget _conversationMessageTime(String time, int index) {
    return Container(
      ...
      child: _timeReFormat(time, index),
    );
  }
